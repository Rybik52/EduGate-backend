...
export interface ApiAttendanceAttendance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entry_time: Schema.Attribute.DateTime & Schema.Attribute.Required;
    exit_time: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    student_group: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiDepartamentDepartament extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    posetitelis: Schema.Attribute.Relation<
      'manyToMany',
      'api::visitor.visitor'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    posetitels: Schema.Attribute.Relation<'manyToMany', 'api::visitor.visitor'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPersoneRolePersoneRole extends Struct.CollectionTypeSchema {
...
export interface ApiStudentsGroupStudentsGroup
  extends Struct.CollectionTypeSchema {
...
export interface ApiVisitorVisitor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    students_groups: Schema.Attribute.Relation<
      'manyToMany',
      'api::students-group.students-group'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::students-group.students-group': ApiStudentsGroupStudentsGroup;
